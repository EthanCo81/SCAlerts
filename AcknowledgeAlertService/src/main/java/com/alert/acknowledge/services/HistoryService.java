...
public class HistoryService {
	...
	//read by id method
	@Transactional
	public AlertHistory readAlertHistory(AlertIdentity alertIdentity) {
		return hd.getOne(alertIdentity);
	}
	...
	//delete by id method
	@Transactional
	public void deleteAlertHistory(AlertIdentity alertIdentity) {
		hd.deleteById(alertIdentity);
	}
}
